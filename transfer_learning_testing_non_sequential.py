...
for n_networks in networks:
    for idx, f in enumerate(south_list):
        ...
        os.makedirs(f'results/tests/non_sequential_splits/transfer_learning/full_dim/{f}/', exist_ok=True)
        ...
        with open(f'results/tests/non_sequential_splits/transfer_learning/full_dim/{f}/error_metrics_total_individual_{n_networks}.csv', 'w') as error_file:
        ...
        fig.savefig(f'results/tests/non_sequential_splits/transfer_learning/full_dim/{f}/forecast_plots_individual_{n_networks}.png')
        plt.close()
