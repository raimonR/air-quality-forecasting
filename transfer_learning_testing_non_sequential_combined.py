...
for n_networks in networks:
    ...
    for f in south_list:
        ...
        with open(f'results/tests/non_sequential_splits/transfer_learning/full_dim/{f}/error_metrics_total_{n_networks}.csv', 'w') as error_file:
        ...
        fig.savefig(f'results/tests/non_sequential_splits/transfer_learning/full_dim/{f}/forecast_plots_{n_networks}.png')
        plt.close()
