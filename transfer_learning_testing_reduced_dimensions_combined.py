...
os.makedirs('results/tests/transfer_learning/reduced_dim/', exist_ok=True)
...
for n_networks in networks:
    ...
    for f in south_list:
        ...
        with open(f'results/tests/transfer_learning/reduced_dim/{f}/error_metrics_total_n{n_networks}.csv', 'w') as error_file:
