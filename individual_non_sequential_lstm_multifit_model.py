...
for f in files:
    os.makedirs(f'results/tests/non_sequential_splits/combined/{f}/', exist_ok=True)
    ...
    with open(f'results/tests/non_sequential_splits/combined/{f}/error_metrics_total.csv', 'w') as error_file:
    ...
    fig.savefig(f'results/tests/non_sequential_splits/combined/{f}/forecast_plots.png')
    plt.close()
