...
np.save('results/tuning/learning_rate_tuning_training_loss', train_loss)
np.save('results/tuning/learning_rate_tuning_validation_loss', val_loss)

with open('results/tuning/lstm_combined_training_learning_rate.pickle', 'wb') as file:
    pickle.dump(historical_train_loss, file, protocol=-1)

with open('results/tuning/lstm_combined_validation_learning_rate.pickle', 'wb') as file:
    pickle.dump(historical_train_loss, file, protocol=-1)
