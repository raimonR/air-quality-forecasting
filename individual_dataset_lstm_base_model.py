...
for idx, f in enumerate(files):
    ...
    with open(f'results/tests/individual_lstm/{f}/error_metrics_total_s1.csv', 'w') as error_file:
    ...
    fig.savefig(f'results/tests/individual_lstm/{f}/forecast_plots_s1.png')
    plt.close()
